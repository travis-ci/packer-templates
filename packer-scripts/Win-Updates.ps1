...
function Check-ContinueRestartOrEnd() {
    Write-Host "BEGIN AUTOUPDATE"
    Get-WUHistory | Out-File C:\PSWindowsUpdate1.log
    Get-WindowsUpdate -install -acceptall -ignorereboot | Get-WindowsUpdate -install -acceptall -ignorereboot | Out-File C:\PSWindowsUpdate2.log
    Write-Host "COMPLETE AUTOUPDATE"
