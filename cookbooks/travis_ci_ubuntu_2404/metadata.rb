...
name 'travis_ci_ubuntu_2404'
maintainer 'Travis CI GmbH'
maintainer_email 'contact+travis-ci-ubuntu-2404-minimal-cookbook@travis-ci.org'
license 'MIT'
description 'Installs/Configures travis_ci_ubuntu_2404'
