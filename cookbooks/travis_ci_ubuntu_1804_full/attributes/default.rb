...
override['travis_postgresql']['alternate_versions'] = []
...
override['travis_system_info']['commands_file'] = \
  '/var/tmp/ubuntu-1804-full-system-info-commands.yml'
...
override['travis_packer_templates']['job_board']['stack'] = 'ubuntu-1804-full'
