...
default['travis_ci_ubuntu_1604']['prerequisite_packages'] = %w[
  cron
  curl
  git
  sudo
...
override['travis_system_info']['commands_file'] = \
  '/var/tmp/ubuntu-1604-system-info-commands.yml'
...
override['travis_build_environment']['otp_releases'] = ["21.1"]
override['travis_build_environment']['elixir_versions'] = ["1.7.4"]
override['travis_build_environment']['default_elixir_version'] = "1.7.4"
...
override['travis_packer_templates']['job_board']['stack'] = 'ubuntu-1604'
